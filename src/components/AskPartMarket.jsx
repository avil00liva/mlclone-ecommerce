  ...
  return (
    <>
        ...
        <div className='w-full min-h-[50px] p-4 mb-4 bg-inherit'>
            ...
            <div className='w-full min-h-[60px] pb-6 flex flex-col tablet:flex-row'>
                <input type="text" placeholder='Escribí tu pregunta...' className='outline-none border border-gray-300 rounded-lg px-4 py-2 w-full placeholder:font-light mr-4 mb-4 tablet:mb-0' value={text} onChange={(e)=>setText(e.target.value)} />
                    ...
                    <div className="w-full min-h-[50px] pb-6 flex flex-col-reverse">
                        {question.map((preg, index)=>{
                            return (
                                <>
                                    {answer &&
                                        <div className='w-full min-h-[60px] mt-1 mb-4 text-gray-500 flex' key={index}>
