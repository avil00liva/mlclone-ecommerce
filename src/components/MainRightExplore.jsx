    ...
    <>
        <div className='p-4 rounded-lg w-full h-auto min-h-[100px] bg-gray-100 exploreSw3 mb-4'>
            ...
            <div className='w-full min-h-[50px] flex justify-between items-center my-2'>
                <h2 className='font-semibold text-xl'>Peluche Stitch 20cm Importado Lilo Y Stitch Hermosos</h2>
                {fav ? 
            ...
            <div className='w-full min-h-[10px] mb-2 flex justify-start items-center'>
                ...
                <small className='text-blue-500 text-xs cursor-pointer'>10° en peluches</small>
            </div>
            <div className='w-full min-h-[10px] mb-4 text-black'>
                <h2 className='text-4xl'>
                    $ 1.150
                </h2>
                <p className='text-base w-[80%]'>en 12x de 211 pesos con 50 centavos $211<sup>50</sup> pagando con Mercado Crédito</p>
...
export default MainRightExplore